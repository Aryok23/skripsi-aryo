\textit{
 ...
 the single highest-scoring variant, yields a detection model that achieves an 
 mAP50-95 of 0.4413 and a mean F1-score of 0.6739 on the test set while running at 9.73 
 frames per second on the deployment device, making it well 
