...
penerapannya pada sistem. Ketiga persoalan tersebut dirumuskan sebagai berikut.
...
\begin{enumerate}
    ...
    \item Model deteksi terbaik belum diimplementasikan ke dalam sistem pemantauan kepadatan berbasis web yang memproses \textit{stream} video kamera CCTV secara \textit{real-time}.
\end{enumerate}
...
\begin{enumerate}
    \item Membangun dataset deteksi sembilan kelas objek kawasan Malioboro (andong, bajaj, becak, sepeda, bus, mobil, motor, orang, dan truk) dari rekaman kamera CCTV melalui anotasi semi-otomatis berbantuan model \textit{pretrained} dengan koreksi manual.
...
\begin{enumerate}
    ...
    \item Dataset yang digunakan adalah data primer yang dibangun dari rekaman kamera CCTV kawasan Malioboro melalui anotasi semi-otomatis dengan koreksi manual. Rincian proses anotasi dijelaskan pada Bab III.
...
data berupa \textit{stream} kamera CCTV, dilanjutkan anotasi semi-otomatis dengan koreksi 
